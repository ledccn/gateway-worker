...
use Ledc\GatewayWorker\Config;
use Ledc\GatewayWorker\EventHandler;

//重置必要的参数
if (class_exists(\GatewayWorker\Lib\Gateway::class)) {
    \GatewayWorker\Lib\Gateway::$registerAddress = Config::getGatewayRegisterAddress() . ':' . Config::getGatewayRegisterListenPort();
    \GatewayWorker\Lib\Gateway::$secretKey = Config::getGatewaySecretKey();
}
...
return [
    ...
    'process' => [
        ...
        'register' => [
            ...
            //监听
            'listen' => 'text://' . Config::getGatewayRegisterListenAddress() . ':' . Config::getGatewayRegisterListenPort(),
            'properties' => [
                //通信密钥
                'secretKey' => Config::getGatewaySecretKey(),
            ],
        ],
        ...
        'gateway' => [
            ...
            'properties' => [
                ...
                'reloadable' => false,
                //本机ip，分布式部署时使用内网ip
                'lanIp' => Config::getGatewayLocalIp(),
                // 内部通讯起始端口，假如$gateway->count=4，起始端口为4000
                // 则一般会使用4000 4001 4002 4003 4个端口作为内部通讯端口
                'startPort' => Config::getGatewayStartPort(),
                //注册中心地址
                'registerAddress' => Config::getGatewayRegisterAddress() . ':' . Config::getGatewayRegisterListenPort(),
                //心跳检测时间间隔
                'pingInterval' => 30,
